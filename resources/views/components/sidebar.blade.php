...
<aside id="separator-sidebar"
    ...
    aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800 border-r-1 border-r-gray-300">
        <h1 class="mb-3 font-bold">LOGO</h1>
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <x-nav-link href='/purchase' :active="request()->is('purchase')">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
